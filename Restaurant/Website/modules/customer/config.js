var config = angular.module("gcApp.config", []).factory("Config", function () {
    ...
    obj.condition = {
        field: "Name",
        query: "PATINDEX('%{0}%',Name) > 0 OR PATINDEX('%{0}%',Phone) > 0 OR PATINDEX('%{0}%',Email) > 0 OR PATINDEX('%{0}%',Description) > 0"
    };
    ...
    obj.fields = [
        ...
        { field: "TypeId", name: "Type", create: true, edit: true, list: true, type: "select2", option: "/Category/GetCustomer_TypeList", required: true },
        { field: "Name", name: "Name", create: true, edit: true, list: true },
        { field: "Phone", name: "Phone", create: true, edit: true, list: true },
        { field: "Email", name: "Email", create: true, edit: true, list: true },
