var config = angular.module("gcApp.config", []).factory("Config", function () {
    ...
    obj.fields = [
        ...
        { field: "RestaurantId", name: "Restaurant", create: false, edit: false, list: false, type: "select2", option: "/Category/GetRestaurantList", required: true },
        { field: "BranchId", name: "Branch", create: true, edit: false, list: true, type: "select2", option: "/Category/GetBranchList", required: true },
        { field: "Name", name: "Name", create: true, edit: true, list: true },
        { field: "Avatar", name: "Image", create: true, edit: true, list: true, type: "upload" },
